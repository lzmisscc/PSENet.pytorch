...
for p in [{'path': '/home/cc/yyzz/123456/pse/yyzz/lsz_res/json', 'txt': '/home/cc/yyzz/123456/pse/yyzz/lsz_res/txt'},
          {'path': '/home/cc/yyzz/123456/pse/yyzz/yyzz_res/json', 'txt': '/home/cc/yyzz/123456/pse/yyzz/yyzz_res/txt'}]:
    path = p['path']
    print(path)
    ...
    for name in tqdm.tqdm(all_dir):
        ...
        with open(join(p['txt'], name.replace('.json', '.txt')), 'w') as f:
            f.writelines(points)
