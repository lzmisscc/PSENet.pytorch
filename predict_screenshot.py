...
if __name__ == '__main__':
    ...
    model_path = 'output/source_auth.pth'

    # 初始化网络
    net = PSENet(backbone='resnet50', pretrained=False, result_num=config.n)
    model = Pytorch_model(model_path, net=net, scale=6, gpu_id=0)

    img_path = 'screenshot/*[png|jpg]'
    ...
    for random_path in img_path:
        ...
        cv2.imwrite(f'result/{os.path.basename(random_path)}', img)
        continue
        cropped_imgs = []
